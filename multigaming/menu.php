...
<div id="menu">
	<ul id="menu">
		...
		<li><a href=<?php echo '"multigaming/root/head/pngs.php?streams=' . makeList(getAllStreams()).'"';?> target="pngs" title="L�dt die PNGs neu, nur die PNGs">PNG refresh</a></li>
		<li><a href="multigaming/pages/impressum.php" target="content" title="Impressum">Impressum</a></li>
		<li><a href="mailto:marder001@gmail.com" title="�ffnet dein standart Mail Programm">Kontakt</a></li>
		<li><a href="multigaming/pages/help.php" target="content" title="Zeigt die Hilfe">Hilfe</a></li> 
		<li><a href="multigaming/pages/changelog.php" target="content" title="Zeigt Ver�nderungen an der Seite">Changelog</a></li>
